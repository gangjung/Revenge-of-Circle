...
public class Enermy_Second : MonoBehaviour
{
            ...
            case STATE.CREATE:
                {
                    ...
                    if (transform.position.y <= 8.0f)
                    {
                        ...
                        GameObject.Find("Canvas").transform.Find("Boss_Second_HP").gameObject.SetActive(true);
            ...
            case STATE.DIE:
                {
                    ...
                    GameObject.Find("Canvas").transform.Find("Boss_Second_HP").gameObject.SetActive(false);

                    GameObject.Find("Canvas").transform.Find("Wait_Final").gameObject.SetActive(true);
    ...
    void Fire()
    {
        GetComponent<PatternManager_Enermy_Second>().enabled = true;
    }
    ...
    void OnCollisionEnter2D(Collision2D coll)
    {
        ...
        if (HP < 0)
        {
            foreach (GameObject obj in GetComponent<Pattern_Enermy_Second_2>().vector)
            {
                Destroy(obj);
            }
